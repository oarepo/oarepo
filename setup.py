...
extras_require = {
    'tests': [
        ...
        'invenio-admin==1.4.0',
        'invenio-administration==1.2.0',
        'invenio-app==1.3.4',
        'invenio-assets==2.0.0',
        'invenio-banners==2.1.0',
        'invenio-base==1.2.13',
        'invenio-cache==1.1.1',
        'invenio-celery==1.2.5',
        'invenio-communities==6.2.1',
        'invenio-config==1.0.3',
        'invenio-db==1.0.14',
        'invenio-drafts-resources==1.2.0',
        'invenio-files-rest==1.5.0',
        'invenio-formatter==1.2.0',
        'invenio-i18n==2.0.0',
        'invenio-indexer==2.1.1',
        'invenio-jsonschemas==1.1.4',
        'invenio-logging==1.3.2',
        'invenio-mail==1.0.2',
        'invenio-oaiserver==2.2.0',
        'invenio-oauth2server==2.0.0',
        'invenio-oauthclient==2.3.0',
        'invenio-pages==3.0.1',
        'invenio-pidstore==1.3.1',
        'invenio-previewer==1.4.0',
        'invenio-queues==1.0.0',
        'invenio-records==2.1.0',
        'invenio-records-files==1.2.1',
        'invenio-records-permissions==0.16.0',
        'invenio-records-resources==2.0.0',
        'invenio-records-rest==2.2.0',
        'invenio-records-ui==1.2.0',
        'invenio-requests==2.0.0',
        'invenio-rest==1.2.8',
        'invenio-s3==1.0.6',
        'invenio-search==2.2.0',
        'invenio-search-ui==2.4.1',
        'invenio-stats==3.0.0',
        'invenio-theme==2.1.2',
        'invenio-userprofiles==2.1.0',
        'invenio-users-resources==1.2.0',
        'invenio-vocabularies==1.2.0',
        'ipython==8.12.0',
        'isbnlib==3.10.13',
        'isort==5.12.0',
        'itsdangerous==2.0.1',
