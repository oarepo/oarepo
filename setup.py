...
extras_require = {
    'tests': [
        ...
        'invenio-communities==4.0.4',
        'invenio-config==1.0.3',
        'invenio-db==1.0.14',
        'invenio-drafts-resources==1.0.3',
        ...
        'invenio-records-resources==1.0.4',
